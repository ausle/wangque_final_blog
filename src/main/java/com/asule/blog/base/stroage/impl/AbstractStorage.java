...
import com.asule.blog.base.stroage.Storage;
...
import com.asule.exception.CommonException;
import com.asule.utils.FileKit;
import com.asule.utils.FilePathUtils;
...
public abstract class AbstractStorage implements Storage {
    ...
    protected void validateFile(MultipartFile file) {
        ...
        if (!FileKit.checkFileType(file.getOriginalFilename())) {
            throw new CommonException("文件格式不支持");
        }
    }
